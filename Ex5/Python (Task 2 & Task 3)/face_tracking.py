        ...
        if not ret_val:
            ...
            if len(p0) <= 10:
                ...
                if len(faces) != 0:
                    ...
                    ##-your-code-starts-here-##
                    # Every points needs to be translated to where the face is located
                    p0[:, 0] += x
                    p0[:, 1] += y
                ...
                ##-your-code-starts-here-##
                good_points = p1[isFound[:, 0] == 1, :]

                ##-your-code-starts-here-##
                
                # Draw points using e.g. cv2.drawMarker
                ##-your-code-starts-here-##
                for x, y in good_points:
                    cv2.drawMarker(img, (int(x), int(y)), color=(0, 255, 0), markerType=cv2.MARKER_DIAMOND, markerSize=20)

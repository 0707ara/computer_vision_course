...
##-your-code-starts-here-##
projected1 = P1t @ np.vstack((ABCDEFGH_w.T, np.ones(8)))
projected2 = P2t @ np.vstack((ABCDEFGH_w.T, np.ones(8)))

# back to non-homogeneou
cx1 = projected1[0, :] / projected1[2, :]
cy1 = projected1[1, :] / projected1[2, :]
cx2 = projected2[0, :] / projected2[2, :]
cy2 = projected2[1, :] / projected2[2, :]
...
for i in range(8):
    ...
    Xcorners[:, i] = vgg_X_fromxP_lin(u, [P1, P2], imsize)
    # function from http://www.robots.ox.ac.uk/~vgg/hzbook/code/
...
##-your-code-starts-here-##
proj1 = P1 @ np.vstack((Xc, np.ones(8)))
proj2 = P2 @ np.vstack((Xc, np.ones(8)))

pcx1 = proj1[0, :] / proj1[2, :]
pcy1 = proj1[1, :] / proj1[2, :]
pcx2 = proj2[0, :] / proj2[2, :]
pcy2 = proj2[1, :] / proj2[2, :]
##-your-code-starts-hee-##
